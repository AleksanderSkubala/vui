...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("div", _hoisted_1$3, [createVNode("label", {
    for: _ctx.name
    ...
    onInput: _cache[1] || (_cache[1] = $event => _ctx.$emit('handleInput', $event.target.value)),
...
const _hoisted_2 = /*#__PURE__*/createVNode("span", null, [/*#__PURE__*/createVNode("svg", {
  width: "12px",
  height: "9px",
  viewbox: "0 0 12 9"
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("div", _hoisted_1, [createVNode("input", {
    type: "checkbox",
    id: _ctx.name,
    onClick: _cache[1] || (_cache[1] = $event => _ctx.$emit('handleCheck', $event.target.checked)),
    class: "vui-checkbox__input",
    style: {
      "display": "none"
    }
  }, null, 8, ["id"]), createVNode("label", {
    class: "vui-checkbox__label",
    for: _ctx.name
  }, [_hoisted_2, createVNode("span", null, toDisplayString(_ctx.label), 1)], 8, ["for"])]);
}
...
export { script$3 as VuiButton, script as VuiCheckbox, script$2 as VuiFormRow, script$1 as VuiFormWrapper, script$4 as VuiInput };
