...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("div", _hoisted_1$3, [createVNode("label", {
    ...
    onInput: _cache[1] || (_cache[1] = function ($event) {
      return _ctx.$emit('handleInput', $event.target.value);
    }),
...
var _hoisted_2 = /*#__PURE__*/createVNode("span", null, [/*#__PURE__*/createVNode("svg", {
  width: "12px",
  height: "9px",
  viewbox: "0 0 12 9"
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("div", _hoisted_1, [createVNode("input", {
    ...
    onClick: _cache[1] || (_cache[1] = function ($event) {
      return _ctx.$emit('handleCheck', $event.target.checked);
    }),
...
var install = function installVui(app) {
